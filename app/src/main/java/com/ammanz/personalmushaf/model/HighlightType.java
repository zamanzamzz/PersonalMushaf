package com.ammanz.personalmushaf.model;
...
public class HighlightType implements Comparable<HighlightType> {
    ...
    public static final HighlightType SELECTION = new HighlightType(1, false, R.color.selectionColor);
    public static final HighlightType AUDIO =     new HighlightType(2, false, R.color.selectionColor);
    public static final HighlightType NOTE =      new HighlightType(3, true,  R.color.selectionColor);
    public static final HighlightType BOOKMARK =  new HighlightType(4, true,  R.color.selectionColor);
