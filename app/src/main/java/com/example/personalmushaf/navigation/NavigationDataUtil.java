...
public class NavigationDataUtil {
    public static String[][] fetchNavigationData(String[] colNames, String table, int juzNumber, boolean needLength) {
        String[][] dataSet;
        Cursor c;
        SQLiteDatabase database = SQLiteDatabase.openDatabase(Environment.getExternalStorageDirectory() + "/personal_mushaf/databases/quran_metadata.db", null, SQLiteDatabase.OPEN_READONLY);
